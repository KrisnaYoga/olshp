            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="../user">
                        ...
                        <div class="form-group row">
                            <label for="prof_img" class="col-md-4 col-form-label text-md-right">{{ __('Profile Image') }}</label>

                            <div class="col-md-6">
                                <input id="prof_img" type="prof_img" class="form-control{{ $errors->has('prof_img') ? ' is-invalid' : '' }}" name="prof_img" value="{{ old('prof_img') }}" required>
